...
PRIME_LOGO = (environ.get('PRIME_LOGO', ''))
...
# MongoDB information *
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://g:g@cluster0.g0ybn.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>File uploaded by [TOM AND JERRY™](https://t.me/DARKSARVAR1)</b>⚡\n\n📂<b>File Name:</b> ⪧ {file_caption} \n <b>Size: </b>{file_size}\n\n❤")
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','DMWITHGOKUL') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','JERRYALLROUNDER') # WITHOUT @
...
# Download Tutorial ButLazyDevelD_TEXT_NAME = "📥 HOW TO DOWNLOAD 📥"
